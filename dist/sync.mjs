import { internal, isObject, isDate, isNullOrUndefined, isString, isFunction, when, applyChanges, endBatch, beginBatch, syncState, linked, isEmpty, shouldIgnoreUnobserved, whenReady, trackSelector, observable, isPromise as isPromise$1, mergeIntoObservable, setAtPath, isPlainObject, ObservableHint, isArray, constructObjectWithPath } from '@legendapp/state';
